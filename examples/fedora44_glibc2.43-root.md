# Execution Log: Fedora 44 (glibc 2.43) with root
...
/usr/bin/ld.bfd: /tmp/cc38YJXG.o: in function `main':
...
[+] Symlinks created: libnss_resolve.so.2 libnss_dns.so.2 libnss_files.so.2 libnss_myhostname.so.2 libnss_mdns4_minimal.so.2
